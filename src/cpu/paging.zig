...
// pml4t (4th layer page table) will never move, but we will write some new entries to it.
pub extern fn get_pml4t_addr() callconv(.c) u64;
...
pub fn init() void {
    ...
    pml4t = @alignCast(@as(*align(4096) PageTable, @ptrFromInt(get_pml4t_addr())));
